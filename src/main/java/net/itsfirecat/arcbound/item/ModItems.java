...
import net.itsfirecat.arcbound.item.custom.*;
...
public class ModItems {
    ...
    public static final Item FREEZE_ARC = registerItem("freeze_arc",
            new FreezeArcItem(new Item.Settings().maxCount(1).fireproof()));

    public static final Item INFINITY_ARTIFACT = registerItem("infinity_artifact", new Item(new Item.Settings()));

    public static final Item INFINITY_ARC = registerItem("infinity_arc",
            new InfinityArcItem(new Item.Settings().maxCount(1).fireproof()));

    public static final Item PULSE_ARTIFACT = registerItem("pulse_artifact", new Item(new Item.Settings()));

    public static final Item PULSE_ARC = registerItem("pulse_arc",
            new PulseArcItem(new Item.Settings().maxCount(1).fireproof()));
    ...
    public static final Item DASH_ARC = registerItem("dash_arc",
            new DashArcItem(new Item.Settings().maxCount(1).fireproof()));
    ...
    public static final Item RESONANCE_ARC = registerItem("resonance_arc",
            new ResonanceArcItem(new Item.Settings().maxCount(1).fireproof()));

    private static Item registerItem(String name, Item item) {
        return Registry.register(Registries.ITEM, Identifier.of(arcbound.MOD_ID, name), item);
    }

    public static void registerModItems() {
        arcbound.LOGGER.info("Registering Mod Items for " + arcbound.MOD_ID);
